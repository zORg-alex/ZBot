...
namespace Bot.ConsoleProgram {
	class Program {
		static void Main(string[] args) {
			...
			//Can be replaced bu db state provider later
			var jsonBotStateProvider = DateBot.Base.JSONDateBotStateProvider.CreateAndLoad(@".\save\botState.json").Result;

			var bot = new DateBot.Base.DateBot(arguments, jsonBotStateProvider);
